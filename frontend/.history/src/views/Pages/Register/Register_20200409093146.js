                ...
                <CardBody className="p-4">
                  <Form>
                    ...
                    <InputGroup className="mb-4">
                      ...
                      <Input type="password" placeholder="Confirmar senha" autoComplete="new-password" />
                    </InputGroup>
                    <Button color="success" block>Criar conta</Button>
                  </Form>
                </CardBody>
                <CardFooter className="p-4">
                <center>Criar conta com:</center><br/>
                  <Row>
                    <Col xs="12" sm="6">
                      <Button className="btn-facebook mb-1" block><span>Tacebook</span></Button>
                    </Col>
                    <Col xs="12" sm="6">
